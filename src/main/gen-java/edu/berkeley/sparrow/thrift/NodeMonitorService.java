...
public class NodeMonitorService {
  ...
  public interface AsyncIface {
    ...
    public void registerBackend(String app, String listenSocket, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;

    public void tasksFinished(List<edu.berkeley.sparrow.thrift.TFullTaskId> tasks, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;

    public void sendFrontendMessage(String app, edu.berkeley.sparrow.thrift.TFullTaskId taskId, int status, ByteBuffer message, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class tasksFinished_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public tasksFinished_call(List<edu.berkeley.sparrow.thrift.TFullTaskId> tasks, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.tasks = tasks;
      }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.tasks = new ArrayList<edu.berkeley.sparrow.thrift.TFullTaskId>(_list16.size);
                  edu.berkeley.sparrow.thrift.TFullTaskId _elem17;
                  for (int _i18 = 0; _i18 < _list16.size; ++_i18)
                  {
                    _elem17 = new edu.berkeley.sparrow.thrift.TFullTaskId();
                    _elem17.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, tasksFinished_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.tasks != null) {
          oprot.writeFieldBegin(TASKS_FIELD_DESC);
          {
            ...
            for (edu.berkeley.sparrow.thrift.TFullTaskId _iter19 : struct.tasks)
            {
              _iter19.write(oprot);
            }
            oprot.writeListEnd();
        ...
        if (struct.isSetTasks()) {
          {
            ...
            for (edu.berkeley.sparrow.thrift.TFullTaskId _iter20 : struct.tasks)
            {
              _iter20.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.tasks = new ArrayList<edu.berkeley.sparrow.thrift.TFullTaskId>(_list21.size);
            edu.berkeley.sparrow.thrift.TFullTaskId _elem22;
            for (int _i23 = 0; _i23 < _list21.size; ++_i23)
            {
              _elem22 = new edu.berkeley.sparrow.thrift.TFullTaskId();
              _elem22.read(iprot);
