...
public class SchedulerStateStoreService {
  ...
  public interface AsyncIface {
    ...
    public void updateNodeState(Map<String,edu.berkeley.sparrow.thrift.TNodeState> snapshot, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class updateNodeState_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public updateNodeState_call(Map<String,edu.berkeley.sparrow.thrift.TNodeState> snapshot, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
  ...
  public static class updateNodeState_args implements org.apache.thrift.TBase<updateNodeState_args, updateNodeState_args._Fields>, java.io.Serializable, Cloneable, Comparable<updateNodeState_args>   {
    ...
    public updateNodeState_args(updateNodeState_args other) {
      if (other.isSetSnapshot()) {
        Map<String,edu.berkeley.sparrow.thrift.TNodeState> __this__snapshot = new HashMap<String,edu.berkeley.sparrow.thrift.TNodeState>(other.snapshot.size());
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
                {
                  ...
                  struct.snapshot = new HashMap<String,edu.berkeley.sparrow.thrift.TNodeState>(2*_map24.size);
                  String _key25;
                  edu.berkeley.sparrow.thrift.TNodeState _val26;
                  for (int _i27 = 0; _i27 < _map24.size; ++_i27)
                  {
                    _key25 = iprot.readString();
                    _val26 = new edu.berkeley.sparrow.thrift.TNodeState();
                    _val26.read(iprot);
                    struct.snapshot.put(_key25, _val26);
                  }
                  iprot.readMapEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, updateNodeState_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.snapshot != null) {
          oprot.writeFieldBegin(SNAPSHOT_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, edu.berkeley.sparrow.thrift.TNodeState> _iter28 : struct.snapshot.entrySet())
            {
        ...
        if (struct.isSetSnapshot()) {
          {
            ...
            for (Map.Entry<String, edu.berkeley.sparrow.thrift.TNodeState> _iter29 : struct.snapshot.entrySet())
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.snapshot = new HashMap<String,edu.berkeley.sparrow.thrift.TNodeState>(2*_map30.size);
            String _key31;
            edu.berkeley.sparrow.thrift.TNodeState _val32;
            for (int _i33 = 0; _i33 < _map30.size; ++_i33)
            {
              _key31 = iprot.readString();
              _val32 = new edu.berkeley.sparrow.thrift.TNodeState();
              _val32.read(iprot);
              struct.snapshot.put(_key31, _val32);
            }
          }
          struct.setSnapshotIsSet(true);
        }
