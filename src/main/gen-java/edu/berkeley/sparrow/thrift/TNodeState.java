...
public class TNodeState implements org.apache.thrift.TBase<TNodeState, TNodeState._Fields>, java.io.Serializable, Cloneable, Comparable<TNodeState> {
  ...
  public int hashCode() {
    ...
    boolean present_sparrowUsage = true && (isSetSparrowUsage());
    list.add(present_sparrowUsage);
    if (present_sparrowUsage)
      list.add(sparrowUsage);
  ...
  public int compareTo(TNodeState other) {
    ...
    lastComparison = Boolean.valueOf(isSetSparrowUsage()).compareTo(other.isSetSparrowUsage());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSparrowUsage()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.sparrowUsage, other.sparrowUsage);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
